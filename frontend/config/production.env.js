...
module.exports = {
  ...
  CODELAB_GITHUB_AUTH_CLIENT_ID: '"' + process.env.CODELAB_GITHUB_AUTH_CLIENT_ID + '"',
  CODELAB_MSU_AUTH_CLIENT_ID: '"' + process.env.CODELAB_MSU_AUTH_CLIENT_ID + '"',
  CODELAB_SERVER_BASE_URL: '"' + process.env.CODELAB_SERVER_BASE_URL + '"'
}
